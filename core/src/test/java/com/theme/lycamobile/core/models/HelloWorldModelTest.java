 ...
 */
package com.theme.lycamobile.core.models;
...
import com.theme.lycamobile.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "lycamobiletheme/components/helloworld");
